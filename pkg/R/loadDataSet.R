...
function() {
    ...
    initdir <- system.file("doc", package="IsoGeneGUI2")
...
Name2 <- tclVar("-- None --")
lab2 <- tklabel(frame1,text="Response")
...
msg <- paste("You have assigned dose object : ",tclvalue(Name1),", response object:",tclvalue(Name2),sep="")
